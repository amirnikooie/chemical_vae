...
def load_models(params):
    ...
    kl_loss_var = tf.Variable(params['kl_loss_weight'], trainable=False) #tf.Variable(params['kl_loss_weight'], trainable=False) #K.variable(params['kl_loss_weight']) # The reason I used tf.Variable is to make sure it is not trainable and be matched
